...
<div class="form-container">
    ...
    <form method="POST" action="<?php echo \Core\View::url('/stock-adjustments/store'); ?>">
            ...
            <select id="medicine_id" name="medicine_id" required>
                ...
                <?php foreach ($medicines as $med): ?>
                    <option value="<?php echo $med['id']; ?>">
                        <?php echo htmlspecialchars($med['name']); ?> (Stock: <?php echo $med['quantity']; ?>)
                    </option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="quantity_change" name="quantity_change" min="-9999" max="-1" placeholder="e.g. -5 (negative for reduction)" required>
            <small style="color: var(--text-secondary);">Use a negative number to reduce stock (damaged, expired, lost).</small>
        </div>
